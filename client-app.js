...
app.get("/", routes.screens.client); // Game Client Screen (root path)
...
// app.get("/channel/:name/", ); // filtered content channel template
...
app.post("/save/:filename", function (req, res, next) {
  ...
  res.write(
    '<link rel="stylesheet" tyle="text/css" href="http://moo.sindome.org/css/client.css">'
  );
